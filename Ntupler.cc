...
int main (int argc, char *argv[])
{
  ...
  //additional xmlfile argument 
	...
	|------------------|*/
	  ...
	  selection.setMuonCuts(25,2.5,0.4,0.2,0.3,1,0.5,5,0); //pt, eta, relIso, d0, NmatchedStations, dz, NtrackerLayers, NpixelHits 
	  selection.setElectronCuts(25,2.5,0.4,0.02,0.5,0.3,0); //et, eta, relIso, d0, MVAid, DRjets, MaxmissingHits
