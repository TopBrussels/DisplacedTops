...
int main (int argc, char *argv[])
{
  ...
  ElectronSFWeight *electronSFWeight_ = new ElectronSFWeight (pathToCaliDir+"LeptonSF/"+electronFile,"EGamma_SF2D",true, false, false); // (... , ... , extendRange , debug, print warning)
