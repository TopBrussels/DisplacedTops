...
samplesrootfiles=["FreyasNtuple/DYJetsToLL_M-50_13TeV-madgraph-pythia8*.root",
                  "FreyasNtuple/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola*.root",
                  "FreyasNtuple/WplusToMuNu_CT10_13TeV-powheg-pythia8*.root",
                  "FreyasNtuple/WminusToMuNu_CT10_13TeV-powheg-pythia8*.root",
                  "FreyasNtuple/QCD_Pt-20to30_EMEnriched_Tune4C_13TeV_pythia8*.root",
                  "FreyasNtuple/QCD_Pt-20toInf_MuEnrichedPt15_PionKaonDecay_Tune4C_13TeV_pythia8*.root",
                  "FreyasNtuple/QCD_Pt-30to50_MuEnrichedPt5_PionKaonDecay_Tune4C_13TeV_pythia8*.root",
                  "FreyasNtuple/QCD_Pt-50to80_MuEnrichedPt5_PionKaonDecay_Tune4C_13TeV_pythia8*.root",
                  "FreyasNtuple/QCD_Pt-80to120_MuEnrichedPt5_PionKaonDecay_Tune4C_13TeV_pythia8*.root",
                  "FreyasNtuple/QCD_Pt-80to170_EMEnriched_Tune4C_13TeV_pythia8*.root",
                  "FreyasNtuple/QCD_Pt_170toInf_bcToE_Tune4C_13TeV_pythia8*.root",
                  "FreyasNtuple/QCD_Pt_30to80_bcToE_Tune4C_13TeV_pythia8*.root",
                  "FreyasNtuple/QCD_Pt_80to170_bcToE_Tune4C_13TeV_pythia8*.root"]
